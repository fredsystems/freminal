...
# default).  Because vendor_conf.d is loaded by every fish session that
# sees our XDG_DATA_DIRS prepend, we must bail under other terminals so we
# don't install hooks or emit OSC 133 sequences they may mis-parse.
