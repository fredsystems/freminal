# PLAN_VERSION_200.md — v0.20.0 "Event Hook API"
...
Depends on essentially all prior feature work (v0.19.0 and earlier). Every subsystem that
...
| --- | -------------------- | ---------- | ------ | ---------------------- |
| 84  | Event Hook API (Lua) | Very Large | Stub   | v0.19.0 (all features) |
...
- **It retrofits, it does not gate.** Status bar (Task 85) and AI (Tasks 87a/87b) shipped
  ...
  before v0.20.0 was blocked waiting on it.
