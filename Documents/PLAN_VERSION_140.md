# PLAN_VERSION_140.md — v0.14.0 "Power-User Toolkit"
...
the event hook API (Task 84) — that lands last (v0.20.0).
...
- **v0.14.0 is keyboard-first.** Every feature has a keybinding and is usable without the
  mouse.
- **No scripting here.** The event hook API (Task 84) is the v0.20.0 capstone; this
