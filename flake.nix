{
  ...
  inputs = {
    ...
    # shell matches the 0.12.0-beta.1+ the release CI installs via `cargo install`.
        ...
        map (system: {
          ...
          value =
            let
              ...
              # produce appimages; this matches the 0.12.0-beta.1+ the release CI uses.
